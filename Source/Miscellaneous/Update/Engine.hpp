...
namespace Update {
    ...
    const uintptr_t Task__Defer = REBASE(0x10D02D0); // 10D02B0 [Maximum re-entrancy depth (%i) exceeded calling task.defer] or [defer] CatalogSortType
